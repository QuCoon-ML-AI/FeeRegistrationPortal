...
import com.pwb.feeRegistrationPortal.repository.database.UserOtpRepository
import com.pwb.feeRegistrationPortal.model.entity.UserOtp
import com.pwb.feeRegistrationPortal.model.entity.User
import com.pwb.feeRegistrationPortal.repository.database.LoginHistoryRepository
import com.pwb.feeRegistrationPortal.repository.database.RoleRepository
import com.pwb.feeRegistrationPortal.repository.database.RolePrivilegeRepository
import com.pwb.feeRegistrationPortal.repository.database.PrivilegeRepository
import com.pwb.feeRegistrationPortal.repository.database.ModuleRepository
...
class AuthenticationService(
   ...
   private val environment: Environment
	...
	fun login(request: LoginRequest):LoginResponse {
		...
		val rolePrivileges = rolePrivilegeRepository.readByRolePrivilegeRoleId(environment.userInfo?.userRoleId?:0)
	...
	fun loadAppConfig(): BaseResponse{
		//TODO LOAD MODULES
		val moduleNames = listOf("USER","FEE","STUDENT","REGISTRATION","USER_OTP","LOGIN_HISTORY","PRIVILEGE","ROLE","ROLE_PRIVILEGE","MODULE","AUDIT_LOG")
